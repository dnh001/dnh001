      ...
      <View className="main-content">
        ...
        <View className="score-badge">
          <View className="score-main">
            <Star className="score-star" size={40} />
        ...
        <View className="stats-grid">
          <View className="stat-card">
            <DollarSign className="stat-icon cost" size={40} />
          ...
          <View className="stat-card">
            <Wifi className="stat-icon wifi" size={40} />
          ...
          <View className="stat-card">
            <Thermometer className="stat-icon weather" size={40} />
          ...
          <View className="stat-card">
            <Shield className="stat-icon safety" size={40} />
        ...
        <ScrollView scrollY className="tab-content">
          {activeTab === 'overview' && (
            <View className="overview-section">
              ...
              <Text className="section-title" style={{ marginTop: 32 }}>Why Nomads Love It</Text>
